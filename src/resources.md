...
| klant | URL-referentie naar een KLANT indien het verzoek niet anoniem is. | string | nee | C​R​U​D |
| interactiedatum | De datum en het tijdstip waarop het verzoek is ingediend. | string | nee | C​R​U​D |
